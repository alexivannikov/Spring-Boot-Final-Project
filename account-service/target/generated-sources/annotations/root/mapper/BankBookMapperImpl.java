...
public class BankBookMapperImpl implements BankBookMapper {
    ...
    public BankBookDto mapToDto(BankBookEntity bankBookEntity) {
        ...
        if ( bankBookEntity.getAmountRUR() != null ) {
            amountRUR = bankBookEntity.getAmountRUR().toString();
        }

        BankBookDto bankBookDto = new BankBookDto( id, user, number, amount, currency, amountRUR );
    ...
    public BankBookEntity mapToEntity(BankBookDto bankBookDto) {
        ...
        if ( bankBookDto.getAmountRUR() != null ) {
            bankBookEntity.setAmountRUR( new BigDecimal( bankBookDto.getAmountRUR() ) );
        }
